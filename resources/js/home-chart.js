...
if (chartEl) {
    ...
    const config = {
        ...
        data: {
            ...
            datasets: [
                { label: approvedLabel, data: getData(monthlyData, 'approved', 10), backgroundColor: '#28a745', borderRadius: 6, barThickness: 14 },
                { label: pendingLabel, data: getData(monthlyData, 'pending', 10), backgroundColor: '#f1c40f', borderRadius: 6, barThickness: 14 },
                { label: declinedLabel, data: getData(monthlyData, 'declined', 10), backgroundColor: '#dc3545', borderRadius: 6, barThickness: 14 },
                { label: expiredLabel, data: getData(monthlyData, 'expired', 10), backgroundColor: '#343a40', borderRadius: 6, barThickness: 14 }
            ]
        },
        options: {
            responsive: true,
